 ...
 * @author oscar
 */
public class rptVentasPorCategorias extends javax.swing.JInternalFrame {

    private conexion mysql = new conexion();
    private Connection cn = mysql.conectar();
    public static int comprobarCompras;

    public rptVentasPorCategorias() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Ventas por Categorias");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rptVentasPorCategorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rptVentasPorCategorias().setVisible(true);
            }
        });
    }
